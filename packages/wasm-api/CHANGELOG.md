...
- update zig `_wasm_allocate()`  & `ManagedIndex` ([3e8870c](https://codeberg.org/thi.ng/umbrella/commit/3e8870c))
...
- add null handling in WasmStringPtr ([e8a094d](https://codeberg.org/thi.ng/umbrella/commit/e8a094d))
  - update logic to interpret as null pointer if addr=0
  - update doc strings
- add null pointer checks, update tests ([247cbbf](https://codeberg.org/thi.ng/umbrella/commit/247cbbf))
...
- update WASM module dependency handling ([31f0358](https://codeberg.org/thi.ng/umbrella/commit/31f0358))
...
- add ObjectIndex.addUnique() ([e79275d](https://codeberg.org/thi.ng/umbrella/commit/e79275d))
- add MemoryView types ([b621adc](https://codeberg.org/thi.ng/umbrella/commit/b621adc))
- add internal memory view accessors ([6830337](https://codeberg.org/thi.ng/umbrella/commit/6830337))
  - these accessors are shared by various types generated via [@thi.ng/wasm-api-bindgen](https://codeberg.org/thi.ng/umbrella/src/branch/main/packages/wasm-api-bindgen)
    and help to drastically cut down filesize of generated code
  - update pkg exports
- update ObjectIndex ctor, make opts fully optional ([564e0f3](https://codeberg.org/thi.ng/umbrella/commit/564e0f3))
...
- update build script for zig v0.12.0 (incomplete) ([99a1916](https://codeberg.org/thi.ng/umbrella/commit/99a1916))
  - store existing script as build-v0.11.zig
- update build script for zig v0.12.0 (incomplete) ([d4fcc54](https://codeberg.org/thi.ng/umbrella/commit/d4fcc54))
  - store existing script as build-v0.11.zig

#### 🩹 Bug fixes

- re-add -rdynamic flag in build.zig ([f509d1e](https://codeberg.org/thi.ng/umbrella/commit/f509d1e))
...
- temporarily disable `WasmLibOpts.out` due to Zig build updates ([cf63c04](https://codeberg.org/thi.ng/umbrella/commit/cf63c04))
...
- add build script for Zig v0.11.0-dev ([4c8abcb](https://codeberg.org/thi.ng/umbrella/commit/4c8abcb))

#### ♻️ Refactoring

- update build-v0.11.zig build script ([fe7c24c](https://codeberg.org/thi.ng/umbrella/commit/fe7c24c))
...
- add ManagedIndex.initCapacity() ([788dfa2](https://codeberg.org/thi.ng/umbrella/commit/788dfa2))
- add WasmType.instanceArray(), add docs ([2adf65f](https://codeberg.org/thi.ng/umbrella/commit/2adf65f))

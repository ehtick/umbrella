...
- update TypeScript codegen to use defType() ([1de3a70](https://codeberg.org/thi.ng/umbrella/commit/1de3a70))
  - re-use `defType()` for generated structs/unions (see [947e3fc1cc](https://codeberg.org/thi.ng/umbrella/commit/947e3fc1cc)),
    resulting in much smaller outputs
  - update test snapshots

#### ♻️ Refactoring

- update TS code gen ([42c6fa3](https://codeberg.org/thi.ng/umbrella/commit/42c6fa3))
...
- update TypeScript codegen ([49d1bc5](https://codeberg.org/thi.ng/umbrella/commit/49d1bc5))
...
- add support for external types ([af1a44d](https://codeberg.org/thi.ng/umbrella/commit/af1a44d))
  - update ICodeGen interface & all impls (C, TS, Zig)
- update JSON schema ([e7bd5a9](https://codeberg.org/thi.ng/umbrella/commit/e7bd5a9))

#### 🩹 Bug fixes

- update type prefix handling in C11 codegen ([5b6fcc2](https://codeberg.org/thi.ng/umbrella/commit/5b6fcc2))
...
- update TS codegen to produce more compact results ([ee5e283](https://codeberg.org/thi.ng/umbrella/commit/ee5e283))
  - update array & slice handling to re-use new helpers in [@thi.ng/wasm-api](https://codeberg.org/thi.ng/umbrella/src/branch/main/packages/wasm-api)
  - update test snapshots
- add getter/setter field flags ([6e87558](https://codeberg.org/thi.ng/umbrella/commit/6e87558))
  - update JSON schema
...
- fix TS codegen address divisor for prim slices ([dfd66ba](https://codeberg.org/thi.ng/umbrella/commit/dfd66ba))
  - update __primSlice()
...
- dedupe struct/union gens for C/Zig ([be628f7](https://codeberg.org/thi.ng/umbrella/commit/be628f7))
- update/dedupe user body injection ([40cbf13](https://codeberg.org/thi.ng/umbrella/commit/40cbf13))
...
- update Zig funcptr codegen to include `callconv(.C)` ([ac3da9e](https://codeberg.org/thi.ng/umbrella/commit/ac3da9e))
...
- add WasmType.instanceArray() impl ([f69d46e](https://codeberg.org/thi.ng/umbrella/commit/f69d46e))

...
- add support for string literals in var assignments ([2749c30](https://codeberg.org/thi.ng/umbrella/commit/2749c30))
  - use string lit to ignore white space in var assignments
    - `name="a b c"` => `--name: a b c;`
  - add/update tests
- add tween-colors() template fn ([a5b8f9d](https://codeberg.org/thi.ng/umbrella/commit/a5b8f9d))
- add border-style specs ([c4cbd2f](https://codeberg.org/thi.ng/umbrella/commit/c4cbd2f))
- add/replace color ops ([ba78142](https://codeberg.org/thi.ng/umbrella/commit/ba78142))
...
- update CLI wrapper, make `bun` optional ([a694c9d](https://codeberg.org/thi.ng/umbrella/commit/a694c9d))
...
- update var assignment check in parser ([7dfe792](https://codeberg.org/thi.ng/umbrella/commit/7dfe792))
...
- support `:` in template args ([a5657dd](https://codeberg.org/thi.ng/umbrella/commit/a5657dd))
...
- update width/height specs ([5e59d5e](https://codeberg.org/thi.ng/umbrella/commit/5e59d5e))
- remove obsolete template defs, update readme ([2f607c0](https://codeberg.org/thi.ng/umbrella/commit/2f607c0))
  - commit which actually removed defs: [ecac29da87](https://codeberg.org/thi.ng/umbrella/commit/ecac29da87)

#### 🩹 Bug fixes

- update `i` key/index handling in generator rules ([4150775](https://codeberg.org/thi.ng/umbrella/commit/4150775))
- update verbatim prop parsing ([0876811](https://codeberg.org/thi.ng/umbrella/commit/0876811))
  - fixes nested selectors in the form `[sel] { ... }`
  - update tests

#### ♻️ Refactoring

- remove obsolete default template specs ([ecac29d](https://codeberg.org/thi.ng/umbrella/commit/ecac29d))
...
- fix parser to priortize var assignments ([937ed79](https://codeberg.org/thi.ng/umbrella/commit/937ed79))
...
- add verbatim property syntax ([0233ba1](https://codeberg.org/thi.ng/umbrella/commit/0233ba1))
...
- add/update CSS specs ([e93d033](https://codeberg.org/thi.ng/umbrella/commit/e93d033))
- update responsive media query breakpoints ([f61a119](https://codeberg.org/thi.ng/umbrella/commit/f61a119))
- add `font-family()` template spec ([849c104](https://codeberg.org/thi.ng/umbrella/commit/849c104))
...
- check for invalid template IDs ([ceb8bb2](https://codeberg.org/thi.ng/umbrella/commit/ceb8bb2))
...
- fix template unit alias handling ([d7f11c0](https://codeberg.org/thi.ng/umbrella/commit/d7f11c0))
...
- add/update animation genspecs ([d7cb506](https://codeberg.org/thi.ng/umbrella/commit/d7cb506))
  - add animation-delay
  - add shrink anim & keyframes
- add support for templated class specs ([eb09f16](https://codeberg.org/thi.ng/umbrella/commit/eb09f16))
  ...
  - add/update tests
- add/update framework specs/templates ([119f385](https://codeberg.org/thi.ng/umbrella/commit/119f385))
- update spec format, add spec doc object & handling ([dc63b3a](https://codeberg.org/thi.ng/umbrella/commit/dc63b3a))
  - update expandSpec() to handle docs & interpolate doc strings
  - refactor convert & export commands
- major update base framework specs ([a985039](https://codeberg.org/thi.ng/umbrella/commit/a985039))
...
- major update spec doc generator ([7117ae9](https://codeberg.org/thi.ng/umbrella/commit/7117ae9))
- improve doc interpolation ([9509cc3](https://codeberg.org/thi.ng/umbrella/commit/9509cc3))
  - also process doc strings for template args
  - extract __interpolateDoc() helper
- update stylesheet line parsing ([ee43572](https://codeberg.org/thi.ng/umbrella/commit/ee43572))
  - add splitLine() to correctly handle more complex tokenization rules
    and perform more checks (e.g. parens matching, nesting)
  - add tests
- add color operation templates (rgb, hsl, lch, oklch) ([b49860e](https://codeberg.org/thi.ng/umbrella/commit/b49860e))
- add/update template specs ([e4ef222](https://codeberg.org/thi.ng/umbrella/commit/e4ef222))

#### 🩹 Bug fixes

- comma-handling in template arg list parsing ([e8d45a5](https://codeberg.org/thi.ng/umbrella/commit/e8d45a5))
  - use negative lookbehind to support `\,` comma-escaping in single args
- update template arity calculation ([ac50c39](https://codeberg.org/thi.ng/umbrella/commit/ac50c39))

#### ♻️ Refactoring

- update color var templates ([5f08683](https://codeberg.org/thi.ng/umbrella/commit/5f08683))
...
- add `develop` cmd, update file watchers ([0380923](https://codeberg.org/thi.ng/umbrella/commit/0380923))
...
- update .mcss syntax, support var assignments ([468c9c5](https://codeberg.org/thi.ng/umbrella/commit/468c9c5))
  - update syntax to support `varname=value` assignments (incl. media prefixes)
  - add tests
- add --only-decls option for export cmd ([ef8ef65](https://codeberg.org/thi.ng/umbrella/commit/ef8ef65))
- update/add/rename commands ([3628c4c](https://codeberg.org/thi.ng/umbrella/commit/3628c4c))
...
- add support for file-local variation defs ([3a8e1a3](https://codeberg.org/thi.ng/umbrella/commit/3a8e1a3))
...
- import as new pkg ([08628b3](https://codeberg.org/thi.ng/umbrella/commit/08628b3))
- switch generated framework output to JSON, simplify ([8850cae](https://codeberg.org/thi.ng/umbrella/commit/8850cae))
- merge media query refs from all inputs ([34047c9](https://codeberg.org/thi.ng/umbrella/commit/34047c9))
- dedupe & merge all selectors & decls ([fd333c8](https://codeberg.org/thi.ng/umbrella/commit/fd333c8))
- add input file watching ([717dbe1](https://codeberg.org/thi.ng/umbrella/commit/717dbe1))
- add error handling for watch mode ([3b8dab9](https://codeberg.org/thi.ng/umbrella/commit/3b8dab9))
- add support for line comments in .meta files ([a6273c8](https://codeberg.org/thi.ng/umbrella/commit/a6273c8))
- add export cmd, update other cmds & arg handling ([f8b326a](https://codeberg.org/thi.ng/umbrella/commit/f8b326a))
- add pretty printing for generate cmd ([2c27c9b](https://codeberg.org/thi.ng/umbrella/commit/2c27c9b))
- add convert option to force include CSS classes ([9932e91](https://codeberg.org/thi.ng/umbrella/commit/9932e91))
- update generate & convert cmds ([15daa6e](https://codeberg.org/thi.ng/umbrella/commit/15daa6e))
- support reading force includes from file ([f92456b](https://codeberg.org/thi.ng/umbrella/commit/f92456b))
- update convert cmd flag spec ([606a585](https://codeberg.org/thi.ng/umbrella/commit/606a585))

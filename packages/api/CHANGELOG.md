...
- add generics for Event & INotify ([7702882](https://codeberg.org/thi.ng/umbrella/commit/7702882))
- add basic utility functions: identity, always, never ([4801e2d](https://codeberg.org/thi.ng/umbrella/commit/4801e2d))
...
- add narrow/widenType() fns ([5ce9938](https://codeberg.org/thi.ng/umbrella/commit/5ce9938))

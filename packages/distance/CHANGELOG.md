...
- rename class Eucledian => Untransformed ([5ace461](https://codeberg.org/thi.ng/umbrella/commit/5ace461))
...
- update KNearest, add setters ([6b185f4](https://codeberg.org/thi.ng/umbrella/commit/6b185f4))

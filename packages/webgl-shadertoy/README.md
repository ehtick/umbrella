...
# ![@thi.ng/webgl-shadertoy](https://codeberg.org/thi.ng/umbrella/media/branch/develop/assets/banners/thing-webgl-shadertoy.svg?a1a6131e)
...
Basic WebGL scaffolding for running interactive fragment shaders via [@thi.ng/shader-ast](https://codeberg.org/thi.ng/umbrella/src/branch/develop/packages/shader-ast). This is a support package for [@thi.ng/webgl](https://codeberg.org/thi.ng/umbrella/src/branch/develop/packages/webgl).

## Status

**ALPHA** - bleeding edge / work-in-progress

[Search or submit any issues for this package](https://codeberg.org/thi.ng/umbrella/issues?q=%5Bwebgl-shadertoy%5D)

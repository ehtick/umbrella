...
- further fix __updateValueAttrib() ([378441c](https://codeberg.org/thi.ng/umbrella/commit/378441c))
...
- fix selection update in  __updateValueAttrib() ([dada2de](https://codeberg.org/thi.ng/umbrella/commit/dada2de))
...
- add support for async iterables ([742e0db](https://codeberg.org/thi.ng/umbrella/commit/742e0db))
  - add $async() component wrapper
  - add $asyncA() attribute wrapper
  - update $compile() to support embedded `AsyncIterable` values
- update wrapper() to support reactive/async attribs ([96ea779](https://codeberg.org/thi.ng/umbrella/commit/96ea779))
...
- update setAttrib() property vs. attrib handling ([52cfe72](https://codeberg.org/thi.ng/umbrella/commit/52cfe72))
...
- remove scheduler, update IComponent signatures ([3728c9b](https://codeberg.org/thi.ng/umbrella/commit/3728c9b))
...
- add $wrapEl() DOM element component wrapper ([298e9a1](https://codeberg.org/thi.ng/umbrella/commit/298e9a1))
...
- add null check for $remove() ([db9d2a1](https://codeberg.org/thi.ng/umbrella/commit/db9d2a1))
- add stream IDs for $list/$klist/$Sub/$SubA ([bfd4058](https://codeberg.org/thi.ng/umbrella/commit/bfd4058))
- add $subWithID(), add IDs for various constructs ([404eacb](https://codeberg.org/thi.ng/umbrella/commit/404eacb))

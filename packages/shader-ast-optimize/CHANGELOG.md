...
- add defOptimized(), rename source file ([b1dc3c0](https://codeberg.org/thi.ng/umbrella/commit/b1dc3c0))
  - add defOptimized() wrapper fn
  - fix spelling in file name
  - update example in docs
- expand constantFolding() features, bug fixes ([1350bf7](https://codeberg.org/thi.ng/umbrella/commit/1350bf7))
...
- update constant folding ([1bd5fef](https://codeberg.org/thi.ng/umbrella/commit/1bd5fef))

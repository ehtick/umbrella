...
- add `#` in URL safety check, update `RequestCtx` ([f0a7025](https://codeberg.org/thi.ng/umbrella/commit/f0a7025))
...
- update static file serving ([e3ee3d6](https://codeberg.org/thi.ng/umbrella/commit/e3ee3d6))
...
- add method adapter, update `RequestCtx` ([360abda](https://codeberg.org/thi.ng/umbrella/commit/360abda))
...
- update RateLimiter to use leaky buckets ([f342fde](https://codeberg.org/thi.ng/umbrella/commit/f342fde))
...
- update `sessionInterceptor()` cookie signing/handling ([bdd4d66](https://codeberg.org/thi.ng/umbrella/commit/bdd4d66))
...
- update interceptor handling ([9cdb8b8](https://codeberg.org/thi.ng/umbrella/commit/9cdb8b8))
...
- update ServerSession & interceptor ([71d26bb](https://codeberg.org/thi.ng/umbrella/commit/71d26bb))
...
- update ServerResponse, update host matching ([25a07f3](https://codeberg.org/thi.ng/umbrella/commit/25a07f3))
  - update `isMatchingHost()`
  - add `ServerResponse.rateLimit()` and `.noResponse()`
  - update tests
- update SessionInterceptor to create signed cookie ([d240107](https://codeberg.org/thi.ng/umbrella/commit/d240107))
  - add `SessionOpts.secret`
  - sign session ID with salt & SHA256
  - add validateSession()
  - update pre() interceptor
- add `rateLimiter()` interceptor ([245cc9d](https://codeberg.org/thi.ng/umbrella/commit/245cc9d))
- add `measure()` interceptor ([4702e84](https://codeberg.org/thi.ng/umbrella/commit/4702e84))
  - refactor logRequest/Response() interceptors

#### ⏱ Performance improvements

- update Server 404 & OPTIONS handling, remove method override ([71307af](https://codeberg.org/thi.ng/umbrella/commit/71307af))
...
- add generics, various other updates ([a340f65](https://codeberg.org/thi.ng/umbrella/commit/a340f65))
...
- migrate/import as new pkg ([61035bb](https://codeberg.org/thi.ng/umbrella/commit/61035bb))
- re-import various security header interceptors ([036b9b2](https://codeberg.org/thi.ng/umbrella/commit/036b9b2))
  - add interceptors:
  ...
  - add/update tests
- update sendFile(), staticFiles() and compression handling ([9f4d25a](https://codeberg.org/thi.ng/umbrella/commit/9f4d25a))
  - add support for brotli, gzip, deflate
  - refactor sendFile() internals
  - disable compression by default
- import refactored cacheControl() interceptor ([4eff206](https://codeberg.org/thi.ng/umbrella/commit/4eff206))
  - update pkg deps & exports
  - update tests
- re-add etag support/handlers ([13fb75e](https://codeberg.org/thi.ng/umbrella/commit/13fb75e))
  - add `StaticOpts.etag`
  ...
  - update tests
- add `server()` factory function (syntax sugar) ([ee22ea1](https://codeberg.org/thi.ng/umbrella/commit/ee22ea1))

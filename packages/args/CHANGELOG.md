...
- add ARG_TYPES index ([5f68489](https://codeberg.org/thi.ng/umbrella/commit/5f68489))

#### ♻️ Refactoring

- update factory fns to only take single arg (spec) ([2766125](https://codeberg.org/thi.ng/umbrella/commit/2766125))
...
- update arg specs & arg factory fns, simplify types ([7ad3efb](https://codeberg.org/thi.ng/umbrella/commit/7ad3efb))
...
- add arg preset specs ([2b13af5](https://codeberg.org/thi.ng/umbrella/commit/2b13af5))
  - add ARG_DRY_RUN
...
- add `terminalLineWidth()` helper ([e8fdd27](https://codeberg.org/thi.ng/umbrella/commit/e8fdd27))
- update ColorTheme and error msg output ([c2bca13](https://codeberg.org/thi.ng/umbrella/commit/c2bca13))
...
- update parse logic to allow option values starting with `-` ([8a9050d](https://codeberg.org/thi.ng/umbrella/commit/8a9050d))
...
- update ColorTheme, add color support for cmd list ([75b1ef1](https://codeberg.org/thi.ng/umbrella/commit/75b1ef1))
...
- add cliApp() runner ([b2248fa](https://codeberg.org/thi.ng/umbrella/commit/b2248fa))
- update lifecycle hooks, add NO_COLOR support, add docs ([4a0ebda](https://codeberg.org/thi.ng/umbrella/commit/4a0ebda))
  - add CLIAppConfig pre/post lifecycle hooks
  - update UsageOpts.color handling
  - add `NO_COLOR` env var support in cliApp()
  - add doc strings
  - update deps
- update cliApp() to support command context extensions ([61d9fb8](https://codeberg.org/thi.ng/umbrella/commit/61d9fb8))
- update cliApp() error handling ([019e5a1](https://codeberg.org/thi.ng/umbrella/commit/019e5a1))
- update argv handling in cliApp() ([b1ed768](https://codeberg.org/thi.ng/umbrella/commit/b1ed768))
- add NO_COLOR aware formatters to CommandCtx ([0e7ddda](https://codeberg.org/thi.ng/umbrella/commit/0e7ddda))
  - update deps

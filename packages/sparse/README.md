...
# ![@thi.ng/sparse](https://codeberg.org/thi.ng/umbrella/media/branch/develop/assets/banners/thing-sparse.svg?15247854)
...
- [@thi.ng/sparse-set](https://codeberg.org/thi.ng/umbrella/src/branch/develop/packages/sparse-set) - TypedArray-based sparse set implementations with extended ES Set API

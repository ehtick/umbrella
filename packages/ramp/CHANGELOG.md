...
- add easing ramp implementations ([1e23b61](https://codeberg.org/thi.ng/umbrella/commit/1e23b61))
  - add `easing()`
...
- dedupe samples() impls ([85515e1](https://codeberg.org/thi.ng/umbrella/commit/85515e1))
...
- add minimal API presets for vector interpolations ([6dcb4b6](https://codeberg.org/thi.ng/umbrella/commit/6dcb4b6))
...
- add support for arbitrary value types ([08e12c3](https://codeberg.org/thi.ng/umbrella/commit/08e12c3))
- BREAKING CHANGE: add support for arbitrary value types, package restructure
  ...
  - update pkg meta
- add nested type support, simplify RampImpl ([0daa663](https://codeberg.org/thi.ng/umbrella/commit/0daa663))
...
- add time domain fns, grouped ramps, update API ([62c01d1](https://codeberg.org/thi.ng/umbrella/commit/62c01d1))

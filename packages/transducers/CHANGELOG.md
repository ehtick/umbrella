...
## [9.7.0](https://codeberg.org/thi.ng/umbrella/src/tag/@thi.ng/transducers@9.7.0/packages/transducers) (2026-09-01)

#### 🚀 Features

- add postProcess() reducer helper ([3bf02d7](https://codeberg.org/thi.ng/umbrella/commit/3bf02d7))
  - add docs/example

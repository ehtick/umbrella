...
- add UncompiledModelSpec, update compileModel() ([95be119](https://codeberg.org/thi.ng/umbrella/commit/95be119))
- update WebGLCanvasOpts, switch to WebGL v2 by default ([6bb029e](https://codeberg.org/thi.ng/umbrella/commit/6bb029e))
  - add docs
- add `ModelSpec.instancePool` ([c4d695f](https://codeberg.org/thi.ng/umbrella/commit/c4d695f))
...
- add passCopyMain() multipass spec utility ([ba22536](https://codeberg.org/thi.ng/umbrella/commit/ba22536))
...
- update shader prelude, add sampler3D default precision ([73d7818](https://codeberg.org/thi.ng/umbrella/commit/73d7818))
  - add `precision lowp sampler3D` to prelude (WebGL2 only)
- update defMultipass(), add sampler3D support ([3f924cf](https://codeberg.org/thi.ng/umbrella/commit/3f924cf))
...
- add retain option to ModelAttributeSpec/IndexBufferSpec ([3db4463](https://codeberg.org/thi.ng/umbrella/commit/3db4463))
  - update defBuffer()/initBuffer()
- add clearCanvas() ([ad362f9](https://codeberg.org/thi.ng/umbrella/commit/ad362f9))
- update glCanvas() return type ([4af5e04](https://codeberg.org/thi.ng/umbrella/commit/4af5e04))
...
- add Shader.withState() ([8a7a427](https://codeberg.org/thi.ng/umbrella/commit/8a7a427))
- update WebGLArrayBuffer/IWebGLBuffer ([c1890ce](https://codeberg.org/thi.ng/umbrella/commit/c1890ce))

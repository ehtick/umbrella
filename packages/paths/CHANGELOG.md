...
- update `deleteIn()` path coercion/check ([8e5e680](https://codeberg.org/thi.ng/umbrella/commit/8e5e680))
  - update path coercion to use `disallowProtoPath()` (like `mutIn()` already does)
  - update docs

#### 🩹 Bug fixes

- update `toPath()` & docs ([202ee9c](https://codeberg.org/thi.ng/umbrella/commit/202ee9c))

...
## [2.3.0](https://codeberg.org/thi.ng/umbrella/src/tag/@thi.ng/file-io@2.3.0/packages/file-io) (2026-06-05)

#### 🚀 Features

- add `readJSONC()`/`readJSONCAsync()` ([c7edf9a](https://codeberg.org/thi.ng/umbrella/commit/c7edf9a))

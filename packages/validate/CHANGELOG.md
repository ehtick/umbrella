...
- add/update validators & tests ([613d332](https://codeberg.org/thi.ng/umbrella/commit/613d332))
  - add `isFunction()`
  - add `ALWAYS`/`NEVER`
  - add `hasRequiredPatternKeys()`
  - add `hasPatternKeysOf()`

## [0.2.0](https://codeberg.org/thi.ng/umbrella/src/tag/@thi.ng/validate@0.2.0/packages/validate) (2026-04-29)

#### 🚀 Features

- add/update validators, combinators, tests, docs ([d8ab5e1](https://codeberg.org/thi.ng/umbrella/commit/d8ab5e1))
